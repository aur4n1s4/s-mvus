                    ...
                    <ul class="nav nav-material nav-material-white responsive-tab" id="v-pegawai-tab" role="tablist">
                        <li>
                            <a class="nav-link" href="javascript:history.back()">
                                <i class="icon icon-arrow_back"></i>Semua Pegawai</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link active show" id="v-status-tab" data-toggle="pill" href="#v-status"
                                    role="tab" aria-controls="v-status" aria-selected="true">Status</a>
                                <a class="nav-link" id="v-username-tab" data-toggle="pill" href="#v-username" role="tab"
                                    aria-controls="v-username" aria-selected="true">Username</a>
                                <a class="nav-link" id="v-password-tab" data-toggle="pill" href="#v-password" role="tab"
                                    aria-controls="v-password" aria-selected="false">Password</a>
                                        ...
                                        <div class="form-row form-inline">
                                            <div class="col-md-12">
                                                ...
                                                <div class="card-body offset-md-3">
                                                    <a href="#" class="btn btn-primary btn-sm" id="action2"
                                                        onclick="send_data(2)"><i class="icon-save mr-2"></i>Simpan<span
                                                            id="txtAction"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group m-0">
                                                    <label for="password_confirmation"
                                                        class="col-form-label s-12 col-md-3">Ulangi Password</label>
                                                ...
                                                <div class="card-body offset-md-3">
                                                    <a href="#" class="btn btn-primary btn-sm" id="action3"
                                                        onclick="send_data(3)"><i class="icon-save mr-2"></i>Simpan<span
                                                            id="txtAction"></span></a>
                                                </div>
                                            </div>
                                        </div>
