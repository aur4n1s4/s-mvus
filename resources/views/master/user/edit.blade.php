                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <a class="nav-link active show" id="v-status-tab" data-toggle="pill"
                                            href="#v-status" role="tab" aria-controls="v-status"
                                            aria-selected="true">Status</a>
                                        <a class="nav-link" id="v-username-tab" data-toggle="pill" href="#v-username"
                                            role="tab" aria-controls="v-username" aria-selected="true">Username</a>
                                        <a class="nav-link" id="v-password-tab" data-toggle="pill" href="#v-password"
                                            role="tab" aria-controls="v-password" aria-selected="false">Password</a>
                                        <a class="nav-link" id="v-pills-roles-tab" data-toggle="pill" href="#v-pills-roles"
                                            role="tab" aria-controls="v-pills-roles" aria-selected="false">List Role</a>
                                        <br />
                                        @if (Auth::user()->id != $user->id)
                                            <a class="btn btn-danger" onclick="removeUser('{{ $user->id }}')">Hapus
                                                User</a>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade active show" id="v-status" role="tabpanel"
                                            ...
                                            <form class="needs-validation" id="form1" method="POST" novalidate>
                                                ...
                                                <ul class="list-group col-5 no-b">
                                                    <li class="list-group-item">
                                                        <strong class="s-12 ml-4">Status User</strong>
                                                        <div class="material-switch float-right">
                                                            <input id="c_status" name="c_status" type="checkbox"
                                                                @if ($user->status == 1) checked="c_status" @endif
                                                                onclick="send_data(1)" />
                                        ...
                                        <div class="tab-pane fade" id="v-username" role="tabpanel"
                                                ...
                                                <div class="form-row form-inline">
                                                    <div class="col-md-12">
                                                        <div class="form-group m-0">
                                                            <label for="username"
                                                                class="col-form-label s-12 col-md-3">Username</label>
                                                        ...
                                                        <div class="card-body offset-md-3">
                                                            <a href="#" class="btn btn-primary btn-sm"
                                                                id="action2" onclick="send_data(2)"><i
                                                                    class="icon-save mr-2"></i>Simpan<span
                                                                    id="txtAction"></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <form class="needs-validation" id="form3" method="POST" novalidate>
                                                ...
                                                <div class="form-row form-inline">
                                                    <div class="col-md-12">
                                                        <div class="form-group m-0">
                                                            <label for="password"
                                                                class="col-form-label s-12 col-md-3">Password</label>
                                                        ...
                                                        <div class="form-group m-0">
                                                            <label for="password_confirmation"
                                                                class="col-form-label s-12 col-md-3">Ulangi
                                                                Password</label>
                                                        ...
                                                        <div class="card-body offset-md-3">
                                                            <a href="#" class="btn btn-primary btn-sm"
                                                                id="action3" onclick="send_data(3)"><i
                                                                    class="icon-save mr-2"></i>Simpan<span
                                                                    id="txtAction"></span></a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-roles" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <form class="needs-validation" id="form4" method="POST"
                                                        novalidate>
                                                        @csrf
                                                        @method('PATCH')
                                                        ...
                                                        <div class="form-row form-inline">
                                                            <div class="col-md-12">
                                                                <div class="form-group m-0">
                                                                    <label for="role"
                                                                        class="col-form-label s-12 col-md-3">Role</label>
                                                                    <div class="col-md-9">
                                                                        <select name="roles[]" id="role"
                                                                            placeholder=""
                                                                            class="select2 form-control r-0 light s-12"
                                                                ...
                                                                <div class="card-body offset-md-3">
                                                                    <a href="#" class="btn btn-primary btn-sm"
                                                                        id="action4" onclick="send_data(4)"><i
                                                                            class="icon-save mr-2"></i>Simpan<span
                                                                            id="txtAction"></span></a>
                                                                </div>
                                                            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function getRoles() {
            ...
            urlRole = "{{ route($route . 'role', ':id') }}".replace(':id', $('#id').val());
            $.get(urlRole, function(data) {
                $('#viewRole').html("");
                if (data.length > 0) {
                    $.each(data, function(index, value) {
                        val = "'" + value + "'";
                        $('#viewRole').append('<li>' + value + ' <a href="#" onclick="removeRole(' + val +
                ...
                buttons: {
                    ok: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                url: "{{ route($route . 'role.destroy', ':name') }}".replace(':name',
                                    name),
                                type: "POST",
                                data: {
                                    '_method': 'DELETE',
