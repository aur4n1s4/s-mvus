        ...
        <div class="row">
                ...
                <div class="card ">
                    ...
                    <div class="card-body no-b">
                        <div class="table-responsive">
                            <table id="table" class="table table-striped" style="width:100%" data-url="{{ route($route . 'api') }}">
                                <thead>
                                    <th width="30">No</th>
                                    <th>Nama</th>
                                    <th>Poli</th>
            ...
            <div class="col-md-4 p-2">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" id="form" method="POST" novalidate enctype="multipart/form-data" data-store-url=" {{ route($route . 'store') }}" data-update-url="{{ route($route . 'update', ':id') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control r-0 s-12" autocomplete="off" required />
                                    </div>

                                    <div class="form-group">
                                        <label for="poli_id" class="col-form-label s-12">
                                            Poliklinik <small class="text-danger">*</small>
                                        </label>
                                        <select name="poli_id" id="poli_id" class="form-control r-0 s-12">
                                    ...
                                    <div class="form-group">
                                        <label for="foto" class="col-form-label s-12">Foto</label>
