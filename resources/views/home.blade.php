...
@section('content')
    <div class="page has-sidebar-left height-full">
        <div class="blue accent-2 p-5">
            <canvas id="myChart" height="300" data-0="{{ $antrian0 }}" data-1="{{ $antrian1 }}"
                data-2="{{ $antrian2 }}" data-3="{{ $antrian3 }}"></canvas>
        </div>
            ...
            <div class="animated fadeInUpShort">
                <div class="card no-b shadow">
                    <div class="card-body p-0">
                        <div class="lightSlider" data-item="{{ count($antrianPolis) }}" data-item-xl="3" data-item-md="2"
                            data-item-sm="1" data-pause="7000" data-pager="false" data-auto="false" data-loop="true">
