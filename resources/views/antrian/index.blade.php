                                    ...
                                    <div class="form-row m-2">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="f-poli" id="f-poli" class="form-control r-0 s-12 filter">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="f-tanggal" class="form-control r-0 s-12 date-time-picker filter" id="f-tanggal" placeholder="Dari tanggal" value="{{ date('Y-m-d') }}" style="height: 39px" />
