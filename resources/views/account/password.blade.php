                        ...
                        <div class="form-row form-inline">
                            <div class="col-md-12">
                                <div class="form-group m-0">
                                    ...
                                    <input type="password" name="password_last" id="password_last" placeholder=""
                                ...
                                <div class="form-group m-0">
                                    <label for="password_confirmation" class="col-form-label s-12 col-md-3">Ulangi
                                        Password</label>
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        placeholder="" class="form-control r-0 light s-12 col-md-4" required
                                        data-match="#password" />
                                </div>
                                <div class="card-body offset-md-3">
                                    <button class="btn btn-primary btn-sm" id="action"><i
                                            class="icon-save mr-2"></i>Simpan Perubahan</button>
                                </div>
                            </div>
                        </div>
                    </form>
